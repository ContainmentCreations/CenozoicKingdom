...
import com.gandalf.entity.AnalyzerBlockEntity;
...
public class AnalyzerBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (!world.isClient) {
            BlockEntity blockEntity = world.getBlockEntity(pos);
            if (blockEntity instanceof AnalyzerBlockEntity) {
                player.openHandledScreen((AnalyzerBlockEntity) blockEntity);
            }
        }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.ANALYZER, AnalyzerBlockEntity::tick);
    }
}
